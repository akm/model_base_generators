...
RSpec.describe "phases/index", type: :view do
  ...
  it "renders a list of phases" do
    ...
    assert_select "tr>td", :text => localize(Time.zone.parse('2020-01-29 02:50:00')), :count => 2
    assert_select "tr>td", :text => localize(Time.zone.parse('2020-01-29 16:40:00')), :count => 2
  end
end
